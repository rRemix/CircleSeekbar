package com.remix.circleseekbar;
...
public class CircleSeekBar extends AbsSeekBar {
    private int DEFAULT_COLOR = Color.parseColor("#b7b7b7");
    /**
     * 是否开启阴影
     */
    ...
    private void init() {
        ...
        if(mThumbDrawable == null){
            mThumbDrawable = mContext.getResources().getDrawable(R.drawable.bg_circleseekbar_thumb_default);
        }

        //已完成轨道颜色 宽度 最大值
        mProgressCorlor = typedArray.getColor(R.styleable.CircleSeekBar_progress_color,
                Color.parseColor("#698cf6"));
    ...
    public interface OnSeekBarChangeListener {
        void onProgressChanged(CircleSeekBar seekBar, long progress);
